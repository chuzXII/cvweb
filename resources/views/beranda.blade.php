          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              ...
              <div class="portfolio-info">
                <h4>{{$dat->nama_project}}</h4>
                <p>App</p>
              </div>
              <div class="portfolio-links">
                <a href="{{asset('img/imgproject')}}/{{$dat->img}}" data-gallery="portfolioGallery" class="portfolio-lightbox" title="{{$dat->nama_project}}"><i class="bx bx-plus"></i></a>
                <a href="{{$dat->link}}" title="To Website"><i class="bx bx-link"></i></a>
              </div>
            </div>
          </div>
          @endforeach
